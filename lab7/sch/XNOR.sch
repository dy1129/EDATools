...
N 310 -50 330 -50 {lab=#net5}
N 400 -120 400 -100 {lab=vdd}
N 400 0 400 20 {lab=gnd}
N 480 -50 500 -50 {lab=#net6}
C {ipin.sym} -570 -140 0 0 {name=p1 lab=A}
C {ipin.sym} -570 -100 0 0 {name=p2 lab=B}
C {opin.sym} 500 -50 0 0 {name=p5 lab=Y}
...
C {lab_pin.sym} 400 20 0 0 {name=p16 sig_type=std_logic lab=gnd}
C {lab_pin.sym} 400 -120 0 0 {name=p17 sig_type=std_logic lab=vdd}
C {/home/dayesong/ETRI050_DesignKit/lab7/sch/inv.sym} 400 -50 0 0 {name=x6}
