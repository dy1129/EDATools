...
N -20 210 90 210 {lab=gnd}
N 90 180 90 210 {lab=gnd}
N -20 150 0 150 {lab=gnd}
N 0 150 0 210 {lab=gnd}
N 80 150 100 150 {lab=gnd}
N 110 150 110 210 {lab=gnd}
N 90 210 110 210 {lab=gnd}
N -20 90 90 90 {lab=Y}
N 40 70 40 80 {lab=Y}
...
N 100 150 110 150 {lab=gnd}
N -20 90 -20 120 {lab=Y}
N 90 90 90 120 {lab=Y}
N 40 80 40 90 {lab=Y}
N 40 80 120 80 {lab=Y}
C {ipin.sym} -120 -40 0 0 {name=p4 lab=A}
C {ipin.sym} -120 150 0 0 {name=p5 lab=B}
C {opin.sym} 120 80 0 0 {name=p2 lab=Y}
C {iopin.sym} 10 -100 2 0 {name=p1 lab=vdd}
C {iopin.sym} -40 240 2 0 {name=p3 lab=gnd}
